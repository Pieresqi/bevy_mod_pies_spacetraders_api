...
impl PurchaseCargo {
    pub fn set_request(
        ...
        self.send_request(rates, MinreqRequestBuilder::new(minreq::Method::Post, Authorization::Required).set_body(request).set_additional_path(format!("my/ships/{}/purchase", ship_symbol)));
    }
}
